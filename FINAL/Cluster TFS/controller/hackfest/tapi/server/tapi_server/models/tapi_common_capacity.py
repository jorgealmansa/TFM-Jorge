...
class TapiCommonCapacity(Model):
    ...
    """
    def __init__(self, bandwidth_profile: TapiCommonBandwidthProfile=None, total_size: TapiCommonCapacityValue=None):  # noqa: E501
        """TapiCommonCapacity - a model defined in Swagger
    ...
    @property
    def total_size(self) -> TapiCommonCapacityValue:
    ...
    @total_size.setter
    def total_size(self, total_size: TapiCommonCapacityValue):
