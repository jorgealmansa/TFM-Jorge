...
class TapiCommonGetserviceinterfacepointlistOutput(Model):
    ...
    """
    def __init__(self, sip: List[TapiCommonServiceInterfacePoint]=None):  # noqa: E501
        """TapiCommonGetserviceinterfacepointlistOutput - a model defined in Swagger

        :param sip: The sip of this TapiCommonGetserviceinterfacepointlistOutput.  # noqa: E501
        :type sip: List[TapiCommonServiceInterfacePoint]
        """
        self.swagger_types = {
            'sip': List[TapiCommonServiceInterfacePoint]
        }
    ...
    @property
    def sip(self) -> List[TapiCommonServiceInterfacePoint]:
    ...
    @sip.setter
    def sip(self, sip: List[TapiCommonServiceInterfacePoint]):
