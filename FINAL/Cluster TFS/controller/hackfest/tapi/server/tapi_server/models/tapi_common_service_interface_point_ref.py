...
class TapiCommonServiceInterfacePointRef(Model):
    ...
    """
    def __init__(self, service_interface_point_uuid: str=None):  # noqa: E501
        """TapiCommonServiceInterfacePointRef - a model defined in Swagger
    ...
    @property
    def service_interface_point_uuid(self) -> str:
    ...
    def service_interface_point_uuid(self, service_interface_point_uuid: str):
