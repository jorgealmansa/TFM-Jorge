...
class TapiConnectivityConnectivityContext(Model):
    ...
    """
    def __init__(self, connectivity_service: List[TapiConnectivityConnectivityService]=None, connection: List[TapiConnectivityConnection]=None):  # noqa: E501
        """TapiConnectivityConnectivityContext - a model defined in Swagger
    ...
    @property
    def connectivity_service(self) -> List[TapiConnectivityConnectivityService]:
    ...
    def connectivity_service(self, connectivity_service: List[TapiConnectivityConnectivityService]):
    ...
    @property
    def connection(self) -> List[TapiConnectivityConnection]:
    ...
    @connection.setter
    def connection(self, connection: List[TapiConnectivityConnection]):
