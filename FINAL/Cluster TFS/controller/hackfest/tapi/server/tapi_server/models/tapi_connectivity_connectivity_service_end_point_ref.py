...
class TapiConnectivityConnectivityServiceEndPointRef(Model):
    ...
    """
    def __init__(self, connectivity_service_uuid: str=None, connectivity_service_end_point_local_id: str=None):  # noqa: E501
        """TapiConnectivityConnectivityServiceEndPointRef - a model defined in Swagger
    ...
    @property
    def connectivity_service_uuid(self) -> str:
    ...
    def connectivity_service_uuid(self, connectivity_service_uuid: str):
    ...
    @property
    def connectivity_service_end_point_local_id(self) -> str:
    ...
    def connectivity_service_end_point_local_id(self, connectivity_service_end_point_local_id: str):
