...
class TapiConnectivityCreateConnectivityService(Model):
    ...
    """
    def __init__(self, output: TapiConnectivityCreateconnectivityserviceOutput=None):  # noqa: E501
        """TapiConnectivityCreateConnectivityService - a model defined in Swagger
    ...
    @property
    def output(self) -> TapiConnectivityCreateconnectivityserviceOutput:
    ...
    @output.setter
    def output(self, output: TapiConnectivityCreateconnectivityserviceOutput):
