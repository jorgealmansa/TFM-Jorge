...
class TapiConnectivityCreateconnectivityserviceInput(Model):
    ...
    @property
    def resilience_constraint(self) -> TapiConnectivityResilienceConstraint:
    ...
    def resilience_constraint(self, resilience_constraint: TapiConnectivityResilienceConstraint):
    ...
    @property
    def connectivity_constraint(self) -> TapiConnectivityConnectivityConstraint:
    ...
    def connectivity_constraint(self, connectivity_constraint: TapiConnectivityConnectivityConstraint):
