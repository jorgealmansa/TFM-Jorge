...
class TapiConnectivityGetConnectionDetails(Model):
    ...
    """
    def __init__(self, output: TapiConnectivityGetconnectiondetailsOutput=None):  # noqa: E501
        """TapiConnectivityGetConnectionDetails - a model defined in Swagger
    ...
    @property
    def output(self) -> TapiConnectivityGetconnectiondetailsOutput:
    ...
    @output.setter
    def output(self, output: TapiConnectivityGetconnectiondetailsOutput):
