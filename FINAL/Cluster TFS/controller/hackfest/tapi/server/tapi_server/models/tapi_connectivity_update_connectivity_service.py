...
class TapiConnectivityUpdateConnectivityService(Model):
    ...
    """
    def __init__(self, output: TapiConnectivityUpdateconnectivityserviceOutput=None):  # noqa: E501
        """TapiConnectivityUpdateConnectivityService - a model defined in Swagger
    ...
    @property
    def output(self) -> TapiConnectivityUpdateconnectivityserviceOutput:
    ...
    @output.setter
    def output(self, output: TapiConnectivityUpdateconnectivityserviceOutput):
