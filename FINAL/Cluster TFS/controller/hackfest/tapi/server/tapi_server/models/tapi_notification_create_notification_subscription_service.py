...
class TapiNotificationCreateNotificationSubscriptionService(Model):
    ...
    """
    def __init__(self, output: TapiNotificationCreatenotificationsubscriptionserviceOutput=None):  # noqa: E501
        """TapiNotificationCreateNotificationSubscriptionService - a model defined in Swagger
    ...
    @property
    def output(self) -> TapiNotificationCreatenotificationsubscriptionserviceOutput:
    ...
    @output.setter
    def output(self, output: TapiNotificationCreatenotificationsubscriptionserviceOutput):
