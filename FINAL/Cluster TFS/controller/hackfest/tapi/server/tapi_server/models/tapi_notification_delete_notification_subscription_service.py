...
class TapiNotificationDeleteNotificationSubscriptionService(Model):
    ...
    """
    def __init__(self, output: TapiNotificationDeletenotificationsubscriptionserviceOutput=None):  # noqa: E501
        """TapiNotificationDeleteNotificationSubscriptionService - a model defined in Swagger
    ...
    @property
    def output(self) -> TapiNotificationDeletenotificationsubscriptionserviceOutput:
    ...
    @output.setter
    def output(self, output: TapiNotificationDeletenotificationsubscriptionserviceOutput):
