...
class TapiNotificationGetNotificationSubscriptionServiceDetails(Model):
    ...
    """
    def __init__(self, output: TapiNotificationGetnotificationsubscriptionservicedetailsOutput=None):  # noqa: E501
        """TapiNotificationGetNotificationSubscriptionServiceDetails - a model defined in Swagger
    ...
    @property
    def output(self) -> TapiNotificationGetnotificationsubscriptionservicedetailsOutput:
    ...
    @output.setter
    def output(self, output: TapiNotificationGetnotificationsubscriptionservicedetailsOutput):
