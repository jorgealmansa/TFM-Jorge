...
class TapiNotificationGetSupportedNotificationTypes(Model):
    ...
    """
    def __init__(self, output: TapiNotificationGetsupportednotificationtypesOutput=None):  # noqa: E501
        """TapiNotificationGetSupportedNotificationTypes - a model defined in Swagger
    ...
    @property
    def output(self) -> TapiNotificationGetsupportednotificationtypesOutput:
    ...
    @output.setter
    def output(self, output: TapiNotificationGetsupportednotificationtypesOutput):
