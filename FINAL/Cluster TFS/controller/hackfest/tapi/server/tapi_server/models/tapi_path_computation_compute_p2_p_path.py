...
class TapiPathComputationComputeP2PPath(Model):
    ...
    """
    def __init__(self, output: TapiPathComputationComputep2ppathOutput=None):  # noqa: E501
        """TapiPathComputationComputeP2PPath - a model defined in Swagger
    ...
    @property
    def output(self) -> TapiPathComputationComputep2ppathOutput:
    ...
    @output.setter
    def output(self, output: TapiPathComputationComputep2ppathOutput):
