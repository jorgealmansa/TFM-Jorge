...
class TapiPathComputationComputep2ppathInput(Model):
    ...
    """
    def __init__(self, topology_constraint: TapiPathComputationTopologyConstraint=None, routing_constraint: TapiPathComputationRoutingConstraint=None, objective_function: TapiPathComputationPathObjectiveFunction=None, sep: List[TapiPathComputationPathServiceEndPoint]=None):  # noqa: E501
        """TapiPathComputationComputep2ppathInput - a model defined in Swagger
    ...
    @property
    def sep(self) -> List[TapiPathComputationPathServiceEndPoint]:
    ...
    @sep.setter
    def sep(self, sep: List[TapiPathComputationPathServiceEndPoint]):
