...
class TapiPathComputationPathComputationContext(Model):
    ...
    """
    def __init__(self, path_comp_service: List[TapiPathComputationPathComputationService]=None, path: List[TapiPathComputationPath]=None):  # noqa: E501
        """TapiPathComputationPathComputationContext - a model defined in Swagger
    ...
    @property
    def path_comp_service(self) -> List[TapiPathComputationPathComputationService]:
    ...
    def path_comp_service(self, path_comp_service: List[TapiPathComputationPathComputationService]):
    ...
    @property
    def path(self) -> List[TapiPathComputationPath]:
    ...
    @path.setter
    def path(self, path: List[TapiPathComputationPath]):
