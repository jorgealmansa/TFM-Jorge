...
class TapiTopologyGetnodedetailsOutput(Model):
    ...
    """
    def __init__(self, node: TapiTopologyNode=None):  # noqa: E501
        """TapiTopologyGetnodedetailsOutput - a model defined in Swagger
    ...
    @property
    def node(self) -> TapiTopologyNode:
    ...
    @node.setter
    def node(self, node: TapiTopologyNode):
