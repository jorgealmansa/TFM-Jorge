...
class TapiTopologyGetnodeedgepointdetailsInput(Model):
    ...
    """
    def __init__(self, ep_id_or_name: str=None, node_id_or_name: str=None, topology_id_or_name: str=None):  # noqa: E501
        """TapiTopologyGetnodeedgepointdetailsInput - a model defined in Swagger
