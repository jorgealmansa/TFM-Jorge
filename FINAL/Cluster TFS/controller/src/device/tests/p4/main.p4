...
const bit<16> UDP_METRICS_PORT = 0x1F91; // 8081
...
control PoT(inout headers hdr,
    ...
    **/
    ...
    action do_clone() {
        ...
        // Establece explícitamente el instance_type a 1 para clones
        standard_metadata.instance_type = BMV2_V1MODEL_INSTANCE_TYPE_INGRESS_CLONE;
