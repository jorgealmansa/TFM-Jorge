...
DEVICE_SW1_IP_ADDR          = '192.168.159.60'
...
DEVICE_SW2_IP_ADDR          = '192.168.159.59'
...
DEVICE_SW3_IP_ADDR          = '192.168.159.59'
...
DEVICE_SW4_IP_ADDR          = '192.168.159.60'
...
ENDPOINT_ID_SW4_3           = DEVICE_SW4_ENDPOINTS[2]['endpoint_id']
...
# Leftmost links
# SW1_2 - SW2_1
LINK_SW1_SW2_UUID           = get_link_uuid(ENDPOINT_ID_SW1_2, ENDPOINT_ID_SW2_1)
LINK_SW1_SW2_ID             = json_link_id(LINK_SW1_SW2_UUID)
LINK_SW1_SW2                = json_link(LINK_SW1_SW2_UUID, [ENDPOINT_ID_SW1_2, ENDPOINT_ID_SW2_1])

# SW2_1 - SW1_2
LINK_SW2_SW1_UUID           = get_link_uuid(ENDPOINT_ID_SW2_1, ENDPOINT_ID_SW1_2)
LINK_SW2_SW1_ID             = json_link_id(LINK_SW2_SW1_UUID)
LINK_SW2_SW1                = json_link(LINK_SW2_SW1_UUID, [ENDPOINT_ID_SW2_1, ENDPOINT_ID_SW1_2])
...
# SW3_2 - SW4_1
LINK_SW3_SW4_UUID           = get_link_uuid(ENDPOINT_ID_SW3_2, ENDPOINT_ID_SW4_1)
LINK_SW3_SW4_ID             = json_link_id(LINK_SW3_SW4_UUID)
LINK_SW3_SW4                = json_link(LINK_SW3_SW4_UUID, [ENDPOINT_ID_SW3_2, ENDPOINT_ID_SW4_1])

# SW4_1 - SW3_2
LINK_SW4_SW3_UUID           = get_link_uuid(ENDPOINT_ID_SW4_1, ENDPOINT_ID_SW3_2)
LINK_SW4_SW3_ID             = json_link_id(LINK_SW4_SW3_UUID)
LINK_SW4_SW3                = json_link(LINK_SW4_SW3_UUID, [ENDPOINT_ID_SW4_1, ENDPOINT_ID_SW3_2])

# ----- Service ----------------------------------------------------------------------------------------------------------

SERVICE_SW1_SW4_UUID          = get_service_uuid(ENDPOINT_ID_SW1_3, ENDPOINT_ID_SW4_3)
SERVICE_SW1_SW4               = json_service_p4_planned(SERVICE_SW1_SW4_UUID)
SERVICE_SW1_SW4_ENDPOINT_IDS  = [DEVICE_SW1_ENDPOINT_IDS[2], DEVICE_SW4_ENDPOINT_IDS[2]]
...
SERVICES = [
    (SERVICE_SW1_SW4, SERVICE_SW1_SW4_ENDPOINT_IDS),
]
